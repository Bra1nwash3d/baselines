...
from baselines.a2c.policies_Predictive import DncPolicyPredictive32
...
def str_to_policy(policy):
    return {
        'dncpred32': DncPolicyPredictive32,
    }.get(policy, DncPolicyPredictive32)
...
def main():
    ...
    parser.add_argument('--policy', help='Policy architecture', choices=['dncpred32'], default='dncpred32')
    parser.add_argument('--lrschedule', help='Learning rate schedule', choices=['constant', 'linear'], default='constant')
    parser.add_argument('--num-timesteps', type=int, default=int(1*10e7))
